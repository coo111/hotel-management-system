...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid" style="background-color: rgba(146,234,189,0.56)">
            <a href="#" class="brand" >
...
<div class="main-container container-fluid">
    ...
    padding-left: 23px;">菜单</h4>
        ...
        <ul class="nav nav-list">
            ...
            <%-- <li>
                 <a id="logId" onclick="" class="dropdown-toggle">
    ...
    <div class="main-content">
        ...
        <div style="width:100%;height:100%;">
            <iframe id="Mainid" src="${ctx}/Main/todata.do" style="width:100%;height:100%;"
                    frameBorder="0"
                    scrolling="no"></iframe>
        </div>
...
<script type="text/javascript">
    ...
    function userInformation() {
        ...
        document.getElementById("smallGuide").innerHTML = s + "";
        document.getElementById('Mainid').src = '${ctx}/users/toListUser.do';
    }
